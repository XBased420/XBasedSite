...
const valid = { name: 'Test Visitor', email: 'visitor@example.com', phone: '(214) 555-0100', business: 'Test Business', type: 'Barber', hasSite: 'No', needs: 'A booking request website.', budget: 'Not sure yet — tell me what it should cost', timeline: 'Few weeks', socials: '', source: '', website: '', turnstileToken: 'valid-test-token', elapsedSeconds: 30 };
