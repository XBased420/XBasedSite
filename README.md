...
Xavier’s one-page Astro site: work, services, prices, story, and project requests. The approved starting prices are **$100 / $500 / +$200 / $100 per month / 50% deposit**. The design uses self-hosted Space Grotesk + Manrope, white/navy/blue, CSS scroll animations, and a small pointer-driven type effect. No animation library, React runtime, or local Astro build is required.
